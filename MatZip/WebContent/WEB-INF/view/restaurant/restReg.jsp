...
<div id="sectionContainerCenter">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=faf4b3a5a0e4ed4c610c95db44ba090d&libraries=services"></script>
	<script>
		function chkFrm() {
		...
		function getLatLng() {
			...
			geocoder.addressSearch(addrStr, function(result, status) {
			    if (status === kakao.maps.services.Status.OK) {
			        ...
			        if(result.length > 0) {
			        	resultGetLatLng.innerText = '좌표 확인 완료';
